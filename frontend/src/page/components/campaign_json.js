...
const data = {
  ...
  "ageOptions": ["13 - 18", "18 - 25", "26 - 59", "60 or older"],
  "ownerAgeRangeSelection": "",

  "goalSelections": ["link clicks", "traffic"],
  "selectedGoals": ["traffic"],

  "industrySelections": ["Accountants",
                          ...
                          "Wine, Beer & Liquor",
                          "Women's Issues "],
  "selectedIndustry": ["Vegan"],

  "feelOptions": ["Relaxed", "Upbeat", "Informative", "Adventerous", "Silly"],
  "selectedFeel": ["Relaxed"],

  "MPAAOptions": ["G", "PG", "PG-13", "R", "NR"],
  "mpaaSelection": ["G"],
