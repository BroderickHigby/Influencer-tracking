...
response = table.query(
	...
	ProjectionExpression="info.full_name, info.bio", # This requests what to show in the response JSON
	...
	KeyConditionExpression=Key('socialauthority').eq(66) # This is the key for the GlobalSecondaryIndex, eq obviously shows what industry I'm looking for
)

for i in response['Items']:
	# print(i['industry'], ":", i['externalid'])
	print(i['socialauthority'], ":", i['info.full_name'], ":", i['info.bio'])
